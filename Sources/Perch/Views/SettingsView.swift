        ...
        ScrollView {
            Form {
                ...
                Section("Context Suggestions") {
                    ...
                    Text(
                        "Perch locally compares the active app, window title, and an available page URL with your pinned and recent pages. When you reveal Perch, it can also check the focused URL for an exact Notion page. This context is never saved or uploaded."
                    )
                    .font(.caption)
                    .foregroundStyle(DesignTokens.Colors.secondaryText)
