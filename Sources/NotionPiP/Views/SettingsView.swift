        ...
        ScrollView {
            Form {
                ...
                if let activePage = runtime.activePage {
                    LabeledContent("Active page", value: activePage.displayTitle ?? activePage.canonicalURL.absoluteString)
                } else {
                ...
                Section("Service Status") {
                    ...
                    LabeledContent("Pinned-page sync", value: runtime.serviceHealth.issues.contains(.pinnedPagePersistenceUnavailable) ? "Needs attention" : "Ready")
                }
