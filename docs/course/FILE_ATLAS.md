...
| Path | Role | Types / artifacts | Consumer | Lecture | Evidence |
|---|---|---|---|---|---|
| [`Sources/NotionPiP/Views/CaptureOutboxStatusView.swift`](../../Sources/NotionPiP/Views/CaptureOutboxStatusView.swift) | Renders durable delivery history/recovery | delivery presentation and outbox view | AppRuntime | [L11](11-views-settings-and-state.md) | Tests: NotionCaptureDeliveryServiceTests |
| [`Sources/NotionPiP/Views/CaptureStatusView.swift`](../../Sources/NotionPiP/Views/CaptureStatusView.swift) | Renders compact capture delivery status | `CaptureStatusView` | capture surfaces | [L11](11-views-settings-and-state.md) | Manual |
...
| [`Sources/NotionPiP/Views/NotionWorkspaceSearchView.swift`](../../Sources/NotionPiP/Views/NotionWorkspaceSearchView.swift) | Renders destination search results | `NotionWorkspaceSearchView` | destination settings | [L11](11-views-settings-and-state.md) | Tests: QuickCaptureDestinationControllerTests |
| [`Sources/NotionPiP/Views/PagePickerView.swift`](../../Sources/NotionPiP/Views/PagePickerView.swift) | Renders generic page choices | `PagePickerDisplay`, `PagePickerView` | standalone capability | [L11](11-views-settings-and-state.md) | Manual |
| [`Sources/NotionPiP/Views/PageSwitcherView.swift`](../../Sources/NotionPiP/Views/PageSwitcherView.swift) | Renders searchable page switching | switcher view and rows | PageSwitcherController | [L11](11-views-settings-and-state.md) | Tests: PageSwitcherMatcherTests |
| [`Sources/NotionPiP/Views/PageURLField.swift`](../../Sources/NotionPiP/Views/PageURLField.swift) | Renders reusable Notion URL entry | `PageURLField` | page URL forms | [L11](11-views-settings-and-state.md) | Tests: NotionPageReferenceTests |
| [`Sources/NotionPiP/Views/PageURLInputView.swift`](../../Sources/NotionPiP/Views/PageURLInputView.swift) | Renders URL-input window and focus | URL input views | PageURLInputState | [L11](11-views-settings-and-state.md) | Tests: PageURLInputPresenterTests |
| [`Sources/NotionPiP/Views/PanelSizeMenu.swift`](../../Sources/NotionPiP/Views/PanelSizeMenu.swift) | Renders panel-size menu choices | `PanelSizeMenu` | PiP chrome | [L11](11-views-settings-and-state.md) | Tests: PanelSizeControllerTests |
| [`Sources/NotionPiP/Views/PanelSizeSettingsView.swift`](../../Sources/NotionPiP/Views/PanelSizeSettingsView.swift) | Renders built-in/custom size settings | settings view and custom rows | PanelSizeController | [L11](11-views-settings-and-state.md) | Tests: PanelSizePreferencesTests |
...
| [`Sources/NotionPiP/Views/PiPChromeView.swift`](../../Sources/NotionPiP/Views/PiPChromeView.swift) | Composes the visible PiP chrome | `PiPChromeView`, toolbar mark | PiP panel hosting | [L11](11-views-settings-and-state.md) | Tests: PiPChromeViewTests |
| [`Sources/NotionPiP/Views/PiPStashHandleView.swift`](../../Sources/NotionPiP/Views/PiPStashHandleView.swift) | Renders and tracks edge-handle interaction | stash handle view/NSView/shape | stash handle controller | [L11](11-views-settings-and-state.md) | Tests: PiPStashHandleInteractionTests |
| [`Sources/NotionPiP/Views/QuickCaptureDestinationSettingsView.swift`](../../Sources/NotionPiP/Views/QuickCaptureDestinationSettingsView.swift) | Renders destination mode/search controls | destination settings view | destination controller | [L11](11-views-settings-and-state.md) | Tests: QuickCaptureDestinationControllerTests |
| [`Sources/NotionPiP/Views/QuickCaptureView.swift`](../../Sources/NotionPiP/Views/QuickCaptureView.swift) | Hosts the local editor and conflict UI | capture view, launch action, WebView representable | capture window | [L11](11-views-settings-and-state.md) | Tests: CaptureWebViewFocusTests |
...
| [`Sources/NotionPiP/Views/SettingsView.swift`](../../Sources/NotionPiP/Views/SettingsView.swift) | Composes all settings groups | `SettingsView` | settings window | [L11](11-views-settings-and-state.md) | Tests: RuntimeActivationAndMenuBarTests |
