...
Dock presence. Perch deliberately selects `.accessory`; its menu-bar icon,
global shortcut, floating panel, and edge handle are the intended access paths.
See [`AppDelegate.applicationWillFinishLaunching`](../../Sources/Perch/App/AppDelegate.swift).

### Actor

A Swift reference type that serializes access to its isolated mutable state.
Perch uses actors for repositories, delivery, and capture lifecycle work
that can be called asynchronously from the main-actor UI. See
[`DeliveryEngine`](../../Sources/Perch/Services/DeliveryEngine.swift).
...
[`CanonicalJSON`](../../Sources/Perch/Domain/CaptureSnapshot.swift).
...
[`StatusItemController`](../../Sources/Perch/Platform/StatusItemController.swift).
...
[`NotionCaptureDeliveryService`](../../Sources/Perch/Services/NotionCaptureDeliveryService.swift).
...
[`CaptureRecordModel.swift`](../../Sources/Perch/Persistence/CaptureRecordModel.swift)
and [`DeliveryState.swift`](../../Sources/Perch/Domain/DeliveryState.swift).
...
[`DurablePageRestoration`](../../Sources/Perch/Domain/PageWorkingSetSnapshot.swift).
...
[`GlobalShortcutRegistrar.swift`](../../Sources/Perch/Platform/GlobalShortcutRegistrar.swift).
...
[`KeychainSecretStore`](../../Sources/Perch/Platform/PersonalTokenCredentialVault.swift).
...
[`AppRuntime`](../../Sources/Perch/App/AppRuntime.swift).
...
failure. See
[`CaptureRepository`](../../Sources/Perch/Persistence/CaptureRepository.swift).
...
[`NotionAPIClient`](../../Sources/Perch/Services/NotionAPIClient.swift).
...
An AppKit window class suited to auxiliary floating UI. Perch's subclass
...
[`KeyCapablePiPPanel`](../../Sources/Perch/Platform/PiPPanelCoordinator.swift)
...
[`NotionWebView`](../../Sources/Perch/Platform/NotionWebView.swift).
...
[`CaptureRepository.saveDraft`](../../Sources/Perch/Persistence/CaptureRepository.swift).
...
[`NotionBlockConverter`](../../Sources/Perch/Services/NotionBlockConverter.swift).
...
[`PageRepository`](../../Sources/Perch/Persistence/PageRepository.swift).
...
[`RetryPolicy.swift`](../../Sources/Perch/Domain/RetryPolicy.swift).
...
[`CaptureSnapshot.swift`](../../Sources/Perch/Domain/CaptureSnapshot.swift).
...
and [`PerchSchema.swift`](../../Sources/Perch/Persistence/PerchSchema.swift).
...
[`PiPChromeView`](../../Sources/Perch/Views/PiPChromeView.swift).
...
[`PanelSizePreferencesStore`](../../Sources/Perch/Persistence/PanelSizePreferencesStore.swift).
...
[`WeakScriptMessageHandler`](../../Sources/Perch/Platform/WeakScriptMessageHandler.swift).

### `WKWebView`

WebKit's embeddable browser view. Perch has two distinct uses: one retained
...
[`NotionWebSession`](../../Sources/Perch/Platform/NotionWebSession.swift)
and [`CaptureEditorSession`](../../Sources/Perch/Platform/CaptureEditorSession.swift).
